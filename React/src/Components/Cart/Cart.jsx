    ...
    <div className="container">
      ...
      {allProducts.length ? <div>
        ...
        <div className='d-flex justify-content-between container'>
          ...
          <button className='btn btn-danger ms-auto' onClick={() => clearCartProducts()}>Clear Cart</button>
        </div>
        <hr />
        <div className="container">
          {allProducts.map((product, idx) => <div className='row' key={idx}>
            ...
            <div className="col-md-9">
              ...
              <h5>price : {product.priceAfterDiscount ? product.priceAfterDiscount : product.price} LE</h5>
            </div>
